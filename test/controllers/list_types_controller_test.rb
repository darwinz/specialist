...
class ListTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_type" do
    assert_difference('ListType.count') do
      post list_types_url, params: {
        list_type: {
          created_at: @list_type.created_at,
          description: @list_type.description,
          updated_at: @list_type.updated_at,
          name: @list_type.name,
  ...
  test "should update list_type" do
    patch list_type_url(@list_type), params: {
      list_type: {
        created_at: @list_type.created_at,
        description: @list_type.description,
        id: @list_type.id,
